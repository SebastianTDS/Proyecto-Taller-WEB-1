...
public class ControladorGrupos2Test  extends HttpSessionTest {
    ...
    public void init() {
        ...
        serviceArchivos = mock(ServicioArchivos.class);
        controller = new ControladorGrupos(serviceGrupo, mock(ServicioNotificacionesImpl.class),mock(ServicioMensajesImpl.class),serviceArchivos);
