...
INSERT INTO grupo(cantidadMax, descripcion, nombre, cerrado, turno, carrera_id, materia_id,esMateria)
VALUES (1,'Foro de la materia', '',1, 'NOCHE', 1, 1, 1 ),
                  (1,'Foro de la materia', '', 0, 'TARDE', 2, 2,1),
                   (1,'Foro de la materia', '', 1, 'NOCHE', 1, 3,1 ),
                   (1,'Foro de la materia', '', 0, 'TARDE', 2, 4,1);
