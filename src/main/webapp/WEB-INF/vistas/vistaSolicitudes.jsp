                ...
                <c:forEach items="${Solicitudes}" var="notificacion">
                    <div class="list-group-item list-group-item-action flex-column">
                        <div class="d-flex w-100 justify-content-between align-items-center">
                            ...
                            <div>
                                <div>
                                    <button type="submit" name="idSolicitudAceptada" form="aceptarSolicitud"
                                            value="${notificacion.getId()}" class="btn btn-outline-success">Aceptar
                                    </button>
                                    <button type="submit" name="idSolicitudRechazada" form="rechazarSolicitud"
                                            value="${notificacion.getId()}" class="btn btn-outline-danger">Rechazar
                                    </button>
                                </div>
                            </div>
                        </div>
